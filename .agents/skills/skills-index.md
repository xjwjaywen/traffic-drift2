...
| gemini-deep-research | `.agents/skills/library/gemini-deep-research/SKILL.md` | Perform complex, long-running research tasks using Gemini Deep Research Agent. Use when: asked to research topics req... |
