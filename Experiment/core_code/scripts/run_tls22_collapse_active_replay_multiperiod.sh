...
STRATEGIES="${STRATEGIES:-random,margin,absorber_random,absorber_margin}"
SEED="${SEED:-0}"
FT_LR="${FT_LR:-0.001}"
FT_EPOCHS="${FT_EPOCHS:-30}"
FT_BATCH_SIZE="${FT_BATCH_SIZE:-64}"
SUMMARY_DIR="${SUMMARY_DIR:-outputs/collapse_active_replay_tls22_summary_${REPLAY_MODE}_r${REPLAY_PER_CLASS}_tr${TARGET_REPEAT}}"
