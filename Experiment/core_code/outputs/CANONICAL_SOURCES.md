...
| Tab 5 (Main results) | `main_results` | TTA: `outputs/baselines_group_metrics_M12/`; FT/Replay: `outputs/ablation_strict/`; AL baselines: `outputs/al_baselines_strict/`; BADGE targeted: `outputs/badge_5seeds_strict/`; Margin targeted: `outputs/care_5seeds_strict_cnn/`; **Margin all-class: `outputs/autonomous_allreplay_5seeds/care/`**; **BADGE all-class: `outputs/badge_allreplay_5seeds/`** | 12 (support≥50) | 5 |
