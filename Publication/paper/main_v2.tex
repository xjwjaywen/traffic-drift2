...
BADGE~\cite{ash2020badge}, which selects diverse uncertain samples via gradient embeddings, achieves the highest collapse F1 ($0.318{\pm}0.037$)---36\% higher than margin ($0.233{\pm}0.002$)---and also the highest macro-F1 ($0.688$ vs.\ $0.673$).
...
\midrule
Static & .629 & .028 & 12 & --- \\
Labeled probe (5s) & .673$\pm$.001 & .233$\pm$.002 & 5.2 & Yes \\
