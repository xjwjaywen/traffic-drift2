...
Here, 14 denotes all classes with recall $<0.1$ regardless of support; the 12-class evaluation set used elsewhere (\S\ref{sec:experiments}) applies a minimum support threshold ($\geq$50 samples) to ensure stable metrics, excluding two low-support classes (15--16 samples each).
