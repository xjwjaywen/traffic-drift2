...
Margin (\ours{}) & .673$\pm$.001 & .233$\pm$.002 & .885 & 5.2 \\
BADGE~\cite{ash2020badge}  & \textbf{.688$\pm$.006} & \textbf{.318$\pm$.037} & \textbf{.889} & \textbf{4.4} \\
\bottomrule
\multicolumn{5}{l}{\footnotesize All active methods use CARE components (replay + distillation).}\\
\multicolumn{5}{l}{\footnotesize BADGE achieves highest F1 but with 6$\times$ higher variance than margin.}
\end{tabular}
\end{table}
