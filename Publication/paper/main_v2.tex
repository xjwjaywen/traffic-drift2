...
Under strict evaluation (queried samples excluded, 5 seeds), \ours{} improves collapse-class F1 from 0.028 to $0.233{\pm}0.003$ ($8\times$) and overall macro-F1 from 0.629 to $0.673{\pm}0.001$ using only 1{,}000 labeled samples ($<$0.3\% of the test set).
An autonomous variant replaces the labeled probe with unsupervised detection, achieving comparable performance ($0.674{\pm}0.001$ macro-F1) with no probe labels at all.
