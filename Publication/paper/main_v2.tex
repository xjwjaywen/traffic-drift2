...
Under strict evaluation, \ours{} improves macro-F1 from 0.629 to $0.673{\pm}0.001$ (5 seeds, labeled-probe) and to $0.673{\pm}0.000$ (3 seeds, autonomous pipeline with detected classes for repair, fixed 12 classes for evaluation), with consistent gains across drift severity (M7--M12), architectures (CNN/Transformer), and an exemplar-free deployment mode.
