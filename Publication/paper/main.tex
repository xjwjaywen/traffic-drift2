...
Five classes achieve recall above 0.62, with one reaching 0.91.
...
\midrule
\textbf{\ours{}}$^\dagger$ & \textbf{.636} & \textbf{.419} & \textbf{.426} & \textbf{.762} & \textbf{.710} & \textbf{.683} \\
\bottomrule
...
\midrule
\textbf{\ours{}}$^\dagger$ & \textbf{0.683} & \textbf{0.426} & 0.891 & \textbf{3} \\
\bottomrule
...
104 & 0.010 & \textbf{0.624} & 0.017 & 0.607 & Substantial \\
...
On CESNET-QUIC22, where only one class collapses (class~71 at W47), \ours{} improves overall accuracy from 0.712 to 0.813 (+10.1\%) at W46 with the random selection strategy.
