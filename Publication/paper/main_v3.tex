...
Under strict evaluation (BADGE, $B{=}1{,}000$, prototype all-class replay $k{=}5$, 5 seeds), \ours{} raises macro-F1 from $0.507{\pm}0.006$ to $0.565{\pm}0.002$ ($+$11.4\%) and collapse-class F1 from $0.027{\pm}0.012$ to $0.056{\pm}0.018$.
The margin variant achieves $0.560{\pm}0.006$ with comparable collapse F1 ($0.056{\pm}0.024$).
...
On QUICEXT-25, the absolute collapse F1 remains low (0.056) despite improvement over the static baseline (0.027), reflecting the difficulty of recovering classes whose features have fully merged in encoder space.
