...
\begin{enumerate}
  ...
  \item \textbf{Label-efficient repair framework.} We propose \ours{}, combining pair-agnostic margin/BADGE selection, all-class replay, head-only fine-tuning, and knowledge distillation. An unsupervised detection module (recall $\geq$0.86 across M7--M12, M12 F1 = 0.71) provides a deployment trigger and diagnostic monitoring (\S\ref{sec:method}, \S\ref{sec:experiments}).
\end{enumerate}
